...
namespace GraphApp.Xamarin
{
	public class TextsEN
	{
		...
		private readonly static String[] insertion = {
			"Vertex insertion Completed!",
			"Edge insertion Completed!",
		};

		private readonly static String[] error = {
			"ERROR" +
		...
		private readonly static String[] help = {
		...
		private readonly static String[] complexity = {
		...
		private readonly static String reference =
			"Complexity:\n" +
			"Kruskal                (pg.633)\n" +
			"Dijkstra               (pg.662)\n" +
			"BFS                    (pg.597)\n" +
